...
And User logout the form
    ...
    Examples: 
      | formname                       | ratingSystem |
      | Green Cleaning-EntrywaySystems | O+M:EB       |
...
And User logout the form
    ...
    Examples: 
      | formname                                | ratingSystem |
      | Green Cleaning-PoweredCleaningEquipment | O+M:EB       |
  ...
  Scenario Outline: Filling Green Cleaning form for CleaningProductsAndMaterials
    ...
    And User Enters data to Narrative field and verifies
    And User enters data to text box with number and verifies
    And User selects option from dropdown and verifies <optionValue>
    And User clicks on Save button
    Then User can able to see the form got saved
    And User verifies the revision icon present after saving the form
    And User dowloads the generated pdf form
...
And User logout the form
    ...
    Examples: 
      ...
      | Green Cleaning-CleaningProductsAndMaterials | O+M:EB       | Inventory   |
...
And User logout the form
    ...
    Examples: 
      | formname                                    | ratingSystem | optionValue          |
      | Green Cleaning-CleaningProductsAndMaterials | O+M:EB       | TotalAnnualPurchases |

  #Scenario-9
  @NegativeTest
  Scenario Outline: Negative scenario for Green Cleaning form for Custodial effectiveness assessment
...
And User logout the form
  ...
  #Scenario-10
  @NegativeTest
  Scenario Outline: Negative scenario for Green Cleaning form for EntrywaySystems
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    And User will select the Radio Button
...
And User logout the form
  ...
  #Scenario-11
  @NegativeTest
  Scenario Outline: Negative scenario for Green Cleaning form for PoweredCleaningEquipment
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    And User will select the Radio Button
...
And User logout the form
  ...
  #Scenario-12
  @NegativeTest
  Scenario Outline: Negative scenario for Green Cleaning form for CleaningProductsAndMaterials
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    And User will select the Radio Button
...
And User logout the form
    ...
    Examples: 
      | formname                                    | ratingSystem | fileName1     | fileName      |
      | Green Cleaning-CleaningProductsAndMaterials | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
