...
And User logout the form
    ...
    Examples: 
      ...
      | Light Pollution Reduction-fixtureShielding | O+M:EB       |
...
And User logout the form
    ...
    Examples: 
      ...
      | Light Pollution Reduction-perimeterMeasurements | O+M:EB       | Table: Site lighting measurements | TD_SiteLightingMeasurements | Yes      |
...
And User logout the form
  ...
  #Scenario-5
  @NegativeTest
  Scenario Outline: Negative scenario for Light Pollution Reduction-fixtureShielding
...
And User logout the form
  ...
  #Scenario-6
  @NegativeTest
  Scenario Outline: Negative scenario for Light Pollution Reduction-perimeterMeasurements
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    When User will select the Radio Button
...
And User logout the form
    ...
    Examples: 
      | formname                                        | ratingSystem | fileName1     | fileName      |
      | Light Pollution Reduction-perimeterMeasurements | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
