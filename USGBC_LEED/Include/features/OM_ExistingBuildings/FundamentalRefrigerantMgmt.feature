...
Feature: Fundamental Refrigerant Management Form - LEED v4.1 O+M: EB
  ...
  #Scenario-7
  @NegativeTest
  Scenario Outline: Negative scenario for Fundamental Refrigerant Management form for noCfcRefrigerants
    ...
    Examples: 
      ...
      #Scenario-9
  @NegativeTest
  Scenario Outline: Negative scenario for Fundamental Refrigerant Management form for Economic Analysis
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    When User will select the Radio Button
    ...
    Examples: 
      ...
      | Fundamental Refrigerant Management-economicAnalysis!R | O+M:EB       | 102MBfile.pdf | 24MBfile1.doc  |
      

  #Scenario-8
  @NegativeTest
  Scenario Outline: Negative scenario for Fundamental Refrigerant Management form for Comprehensive Phase-Out Plan
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    When User will select the Radio Button
    ...
    Examples: 
      | formname                                                   | ratingSystem | fileName1     | fileName      |
      | Fundamental Refrigerant Management-comprehensivePhaseOut!R | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
