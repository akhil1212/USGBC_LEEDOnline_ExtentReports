...
# Last Updated By:
# Last Updated On:
# Feature Name: Minimum Indoor Air Quality Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Minimum Indoor Air Quality Form - LEED v4.1 O+M: EB
  ...
  #Scenario-3
  @NegativeTest
  Scenario Outline: Negative scenario for Minimum Indoor Air Quality
    ...
    Examples: 
      ...
      | Minimum Indoor Air Quality | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
