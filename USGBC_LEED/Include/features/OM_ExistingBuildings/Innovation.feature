...
# Last Updated By:
# Last Updated On:
# Feature Name: Innovation Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Innovation Form - LEED v4.1 O+M: EB
...
And User logout the form
    ...
    Examples: 
      ...
      | Innovation-PilotCredit | O+M:EB       |SSpc55 - Bird collision deterrence|
...
And User logout the form
    ...
    Examples: 
      | formname               | ratingSystem |optionValue|
      | Innovation-PilotCredit | O+M:EB       |SSpc82 - Local food production|

  #Scenario-5
  @NegativeTest
  Scenario Outline: Negative scenario for Innovation form for InnovationStrategy
...
And User logout the form
    ...
    Examples: 
      ...
      | Innovation-InnovationStrategy | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |

  #Scenario-6
  @NegativeTest
  Scenario Outline: Negative scenario for Innovation form for PilotCredit
    Given User clicks on project <ratingSystem> Negative
    And User navigates to the credits page of the project
    And User should be on form <formname>
    When User will select the Radio Button
    ...
    Examples: 
      | formname               | ratingSystem | fileName1     | fileName      |
      | Innovation-PilotCredit | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
