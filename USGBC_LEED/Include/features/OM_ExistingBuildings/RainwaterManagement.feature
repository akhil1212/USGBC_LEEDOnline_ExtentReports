...
# Last Updated By:
# Last Updated On:
# Feature Name: Rainwater Management Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Rainwater Management Form  - LEED v4.1 O+M: EB
...
And User logout the form
    ...
    Examples: 
      ...
      | Rainwater Management | O+M:EB       |

  #Scenario-2
  @SmokeTest
  Scenario Outline: Checking Auto Save functionality  in Rainwater Management form
...
And User logout the form
  ...
  #Scenario-3
  @NegativeTest
  Scenario Outline: Negative scenario for Rainwater Management form
...
And User logout the form
    ...
    Examples: 
      ...
      | Rainwater Management | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
