...
# Last Updated By:
# Last Updated On:
# Feature Name: Purchasing Policy Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Purchasing Policy Form - LEED v4.1 O+M: EB
  ...
  #Scenario-3
  @NegativeTest
  Scenario Outline: Negative scenario for Purchasing Policy form
    ...
    Examples: 
      ...
      | Purchasing Policy | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
