...
# Last Updated By:
# Last Updated On:
# Feature Name: Project Information Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Project Information Form - LEED v4.1 O+M: EB
  ...
  Scenario Outline: Filling Project Information form
    ...
    Examples: 
      ...
      | Project Information | O+M:EB       |

  #Scenario-2
  @SmokeTest
  Scenario Outline: Checking Auto Save functionality in Project Information form for noCfcRefrigerants
  ...
  #Scenario-3
  @NegativeTest
  Scenario Outline: Negative scenario for Project Information
    ...
    Examples: 
      ...
      | Project Information | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
