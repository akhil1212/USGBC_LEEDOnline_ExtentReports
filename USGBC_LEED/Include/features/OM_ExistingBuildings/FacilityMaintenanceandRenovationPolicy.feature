...
# Last Updated By:
# Last Updated On:
# Feature Name: Facility Maintenance and Renovation Policy Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Facility Maintenance and Renovation Policy Form - LEED v4.1 O+M: EB
...
#Scenario-1
  ...
  Scenario Outline: Filling Facility Maintenance and Renovation Policy
    ...
    Examples: 
      ...
      | Facility Maintenance and Renovation Policy | O+M:EB       |
...
#
  #Scenario-3
  #@NegativeTest
  #Scenario Outline: Negative scenario for Filling Facility Maintenance and Renovation Policy
    #Given User clicks on project <ratingSystem> positiveFlow
    #And User navigates to the credits page of the project
    #And User should be on form <formname>
...
#
    #Examples: 
      ...
      #| Facility Maintenance and Renovation Policy | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |