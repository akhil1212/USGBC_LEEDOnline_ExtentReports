...
# Last Updated By:
# Last Updated On:
# Feature Name: Energy Efficiency Best Management Practices Form - LEED v4.1 O+M: EB
...
#---------------------------------------------------------------------------------------------------------------------------------
@cucumberTags
Feature: Energy Efficiency Best Management Practices Form - LEED v4.1 O+M: EB
  ...
  #Scenario-3
  @NegativeTest
  Scenario Outline: Negative scenario for Energy Efficiency Best Management Practices
    ...
    Examples: 
      ...
      | Energy Efficiency Best Management Practices | O+M:EB       | 24MBfile1.doc | 102MBfile.pdf |
